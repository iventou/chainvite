...
import (
	...
	"github.com/iventou/chainvite/app"
)
...
// genesisCommand builds genesis-related `chainvited genesis` command. Users may provide application specific commands as a parameter
